...
class Odin_User_Meta {
	...
	public function view() {
		...
		foreach ( $this->fields as $field ) {
			...
			echo apply_filters( 'race_chrome_user_meta_field_before_' . $this->id, '<td>', $field );
			...
			echo apply_filters( 'race_chrome_user_meta_field_after_' . $this->id, '</td>', $field );
	...
	public function save( $user_id ) {
		...
		foreach ( $this->fields as $field ) {
			...
			$new  = apply_filters( 'race_chrome_save_user_meta_' . $this->id, $_POST[ $name ], $name );
