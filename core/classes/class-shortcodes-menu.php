...
class Odin_Shortcodes_Menu {
	 ...
	 *
	 * @return array          Race Chrome TinyMCE plugin.
	 */
	public function add_shortcode_tinymce_plugin( $plugins ) {
		$plugins[ 'race_chrome_shortcodes' ] = get_template_directory_uri() . "/core/assets/js/editor-shortcodes.js";
	...
	public function register_shortcode_button( $buttons ) {
		array_push( $buttons, '|', 'race-chrome' );
	...
	public function add_tinymce_locales( $locales ) {
		$locales[ 'race_chrome_shortcodes' ] = plugin_dir_path( __FILE__ ) . '/../../inc/race-chrome-shortcodes-editor-i18n.php';
